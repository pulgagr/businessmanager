...
// Define tracking form interface
    ...
    return (
      <div className="min-h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading shipments data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Delivery Tracker</h1>
      ...
      <div className="mt-8">
        <div className="bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.1)] transition-all duration-300 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)] overflow-hidden">
          <div className="border-b border-gray-200 px-6 py-5">
            <h3 className="text-lg font-semibold text-gray-900">Shipments List</h3>
            <p className="mt-1 text-sm text-gray-500">View and manage all shipments</p>
          </div>
                ...
                {trackings.map((tracking) => (
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      {tracking.client?.company || tracking.client?.name}
                    </td>
      ...
      <FormModal
        ...
        showDeleteButton={!!editingTracking}
        onDelete={() => {
          if (editingTracking) {
            setDeletingTracking(editingTracking);
      ...
      <ConfirmationModal
        ...
        description={`Are you sure you want to delete the shipment ${deletingTracking?.trackingNumber}? This action cannot be undone.`}
        type="delete"
      />
    </div>
  );
